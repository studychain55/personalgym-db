...
export default function ColumnIndexPage() {
  ...
  const columns = [
    {
      title: "パーソナルトレーニングで肩痛改善｜原因から効果的な対策まで完全ガイド",
    ...
    {
      title: "パーソナルトレーニングで首痛改善｜原因から効果的な対策まで完全ガイド",
    ...
    {
      title: "パーソナルトレーニングで膝痛改善｜原因から根本的な解決まで完全ガイド",
    ...
    {
      title: "パーソナルトレーニングで腰痛改善｜原因から効果的な対策まで完全ガイド",
    ...
    {
      title: "パーソナルジムで効率的に筋肉を増やす方法｜科学的なトレーニング・栄養戦略",
    ...
    {
      title: "パーソナルジムで体脂肪率を低下させる科学的方法｜効率的な低下ペースと実践的ガイド",
    ...
    {
      title: "パーソナルジムでの体重減量完全ガイド｜リバウンドなし・成功の法則",
    ...
    {
      title: "パーソナルジムのスケジュール管理完全ガイド｜通う頻度と時間調整",
    ...
    {
      title: "パーソナルジムでのストレッチ指導｜柔軟性と可動域改善の科学的方法",
    ...
    {
      title: "パーソナルジム栄養ガイド｜初心者向け食事管理の完全ステップ",
    ...
    {
      title: "マラソン完走のためのパーソナルトレーニング｜タイム短縮と怪我予防ガイド",
    ...
    {
      title: "結婚式に向けたパーソナルジムでの体型改善｜ブライダルボディメイクの完全ガイド",
    ...
    {
      title: "ファンクショナルトレーニング｜日常動作改善・スポーツパフォーマンス向上",
      description: "ファンクショナルトレーニングの定義、日常生活改善効果、スポーツパフォーマンス向上のメカニズム、代表的な種目（デッドリフト・ケトルベルスイング・ランジ）、QOL向上の具体例、従来の筋トレとの最適な組み合わせについてわかりやすく解説します。",
      path: "/column/gym-functional/",
      date: "2026-04-07",
      category: "トレーニング方法",
    },
    {
      title: "スタミナ・持久力向上トレーニング｜疲れにくい体を作る方法",

      ...
      <section className="bg-gradient-to-br from-[#FFF3ED] to-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center items-center">
            <NextLink
              href="/all/"
              className="inline-block bg-[#1e782d] text-white font-bold px-10 py-4 rounded-lg hover:bg-[#E55E2F] transition-colors no-underline text-lg shadow-md"
            >
              パーソナルジムを探す →
            </NextLink>
            <NextLink
              href="#area"
              className="inline-block border-2 border-[#1e782d] text-[#1e782d] font-bold px-8 py-3.5 rounded-lg hover:bg-[#f0f6f0] transition-colors no-underline"
            >
              エリアから探す
            </NextLink>
          </div>

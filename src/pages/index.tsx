      ...
      <section className="bg-gradient-to-br from-[#FFF3ED] to-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <NextLink
              href="/all/"
              className="inline-block bg-[#1e782d] text-white font-bold px-8 py-3 rounded-lg hover:bg-[#155420] transition-colors no-underline text-lg"
            >
              ジム一覧を見る →
            </NextLink>
            <NextLink
              href="/all/?female=1"
              className="inline-block bg-white border-2 border-pink-500 text-pink-600 font-bold px-6 py-3 rounded-lg hover:bg-pink-50 transition-colors no-underline"
            >
              女性専用ジムを探す
            </NextLink>
            <NextLink
              href="/all/?trial=1"
              className="inline-block bg-white border-2 border-[#1e782d] text-[#1e782d] font-bold px-6 py-3 rounded-lg hover:bg-[#f0f6f0] transition-colors no-underline"
            >
              無料体験あり
            </NextLink>
          </div>
          ...
          <div className="mt-6 flex flex-wrap gap-2 justify-center">
            <span className="text-sm text-gray-500 self-center">目的から探す:</span>
            <NextLink href="/all/?diet=1" className="text-sm bg-white border border-gray-200 rounded-full px-4 py-1.5 text-gray-700 hover:border-[#1e782d] hover:text-[#1e782d] transition-colors no-underline">ダイエット</NextLink>
            <NextLink href="/f-muscle-gain/" className="text-sm bg-white border border-gray-200 rounded-full px-4 py-1.5 text-gray-700 hover:border-[#1e782d] hover:text-[#1e782d] transition-colors no-underline">筋力アップ</NextLink>
            <NextLink href="/all/?moneyback=1" className="text-sm bg-white border border-gray-200 rounded-full px-4 py-1.5 text-gray-700 hover:border-[#1e782d] hover:text-[#1e782d] transition-colors no-underline">返金保証あり</NextLink>
            <NextLink href="/#area" className="text-sm bg-white border border-gray-200 rounded-full px-4 py-1.5 text-gray-700 hover:border-[#1e782d] hover:text-[#1e782d] transition-colors no-underline">エリアから探す</NextLink>
          </div>
        </div>
      </section>

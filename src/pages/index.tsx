      ...
      <section className="bg-gradient-to-br from-[#FFF3ED] to-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-3">
            <NextLink
              href="/all/"
              className="inline-block bg-[#1e782d] text-white font-bold px-10 py-4 rounded-xl text-lg hover:bg-[#185e24] transition-colors no-underline shadow-lg"
            >
              無料で比較する →
            </NextLink>
            <p className="text-sm text-gray-500">無料・登録不要でかんたんに探せます</p>
          </div>
        </div>
      </section>

        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <form onSubmit={handleSearch} className="mt-8 max-w-xl mx-auto flex gap-2">
            <input
              ...
              placeholder="エリア・駅名・ジム名で検索"
              className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#1e782d] bg-white"
            />
            <button
              type="submit"

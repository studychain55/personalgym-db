      ...
      <section className="bg-gradient-to-br from-[#FFF3ED] to-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center items-center">
            <NextLink
              href="/all/"
              className="inline-block bg-[#1e782d] text-white font-bold px-10 py-4 rounded-xl text-lg hover:bg-[#155420] transition-colors no-underline shadow-md"
            >
              無料でジムを探す →
            </NextLink>
            <NextLink
              href="/area/"
              className="inline-block bg-white text-[#1e782d] font-bold px-8 py-4 rounded-xl text-base border-2 border-[#1e782d] hover:bg-[#f0f6f0] transition-colors no-underline"
            >
              エリアから探す
            </NextLink>
          </div>
          <p className="mt-4 text-sm text-gray-500">無料・会員登録不要で利用できます</p>
        </div>
      </section>

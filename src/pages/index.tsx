      ...
      <section className="bg-gradient-to-br from-[#FFF3ED] to-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <NextLink
              href="/all/"
              className="inline-block bg-[#E53935] text-white font-bold px-8 py-4 rounded-xl text-lg hover:bg-[#C62828] transition-colors no-underline shadow-md"
            >
              まずは無料で探す →
            </NextLink>
            <NextLink
              href="/all/?trial=1"
              className="inline-block bg-white text-[#1e782d] border-2 border-[#1e782d] font-bold px-8 py-4 rounded-xl text-lg hover:bg-[#f0f6f0] transition-colors no-underline"
            >
              無料体験を探す
            </NextLink>
          </div>
          <p className="text-xs text-gray-400 mt-3">登録不要・完全無料で比較できます</p>
        </div>
      </section>

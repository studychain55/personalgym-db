      ...
      <section className="bg-gradient-to-br from-[#FFF3ED] to-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center items-center">
            <NextLink
              href="/all/"
              className="inline-block bg-[#1e782d] text-white font-bold px-8 py-3 rounded-full hover:bg-[#155420] transition-colors no-underline shadow-md"
            >
              ジム一覧を見る →
            </NextLink>
            <NextLink
              href="/all/?trial=1"
              className="inline-block border-2 border-[#1e782d] text-[#1e782d] font-bold px-8 py-3 rounded-full hover:bg-[#f0f6f0] transition-colors no-underline"
            >
              🎯 無料体験を探す
            </NextLink>
          </div>
          <p className="mt-4 text-sm text-gray-400">無料カウンセリング対応ジム多数掲載</p>
        </div>
      </section>

      ...
      <section className="bg-gradient-to-br from-[#FFF3ED] to-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <NextLink
              href="/all/"
              className="inline-block bg-[#E55E2F] text-white font-bold px-10 py-4 rounded-full text-lg hover:bg-[#C94B20] transition-colors no-underline shadow-lg"
            >
              無料で今すぐジムを比較する →
            </NextLink>
            <NextLink
              href="/all/?trial=1"
              className="inline-block bg-white border-2 border-[#1e782d] text-[#1e782d] font-bold px-8 py-3.5 rounded-full text-base hover:bg-[#f0f6f0] transition-colors no-underline"
            >
              体験レッスンを探す
            </NextLink>
          </div>

      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            {/* フィルタトグルボタン + 体験クイックフィルタ */}
            <div className="flex items-center gap-2 lg:hidden">
              <button
                onClick={() => handleFeatureToggle("hasTrialAvailable")}
                className={`px-3 py-2 rounded-full text-sm font-bold border transition-colors ${features.hasTrialAvailable ? "bg-[#1e782d] text-white border-[#1e782d]" : "bg-white text-gray-700 border-gray-300 hover:border-[#1e782d] hover:text-[#1e782d]"}`}
              >
                無料体験あり
              </button>
              <button
              ...
              >
                ...
                その他 {activeFilterCount > 0 && <span className="text-[#1e782d] font-bold">({activeFilterCount})</span>}
              </button>
            </div>
          </div>

  ...
  return (
    <Layout>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {/* About Section (moved below gym list) */}
        <section className="mt-8 p-5 bg-gray-50 rounded-lg border border-gray-200">
          <h2 className="text-xl font-bold text-gray-900 mb-3">全国のパーソナルジムについて</h2>
          <p className="text-gray-700 mb-2">
            全国には{totalCount}件以上のパーソナルジムが存在します。ダイエット・ボディメイク・健康増進など、様々な目的に対応したジムが揃っています。プロのトレーナーによるマンツーマン指導で、効率的に目標を達成することができます。
          </p>
          <p className="text-gray-700">
            フィルタ機能を使って、女性向け・初心者向け・返金保証ありなど、自分の条件に合ったジムを素早く見つけられます。
          </p>
        </section>

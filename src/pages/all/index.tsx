      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            {activeFilterCount > 0 && (
              <span className="inline-flex items-center gap-1 bg-[#1e782d] text-white text-xs font-bold px-3 py-1 rounded-full self-start sm:self-auto">
                絞り込み中 {activeFilterCount}件
              </span>
            )}
          </div>

          {/* フィルタセクション - always visible */}
          <div className="pt-4 border-t border-gray-200 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* 価格帯フィルタ */}
            <div>

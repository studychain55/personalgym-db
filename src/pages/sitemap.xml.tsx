...
export const getServerSideProps: GetServerSideProps = async ({ res }) => {
  ...
  const urls = [
    ...
    { loc: "/column/gym-cardio/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-abs/", changefreq: "monthly", priority: "0.7" },
    ...
    { loc: "/column/gym-supplement/", changefreq: "monthly", priority: "0.7" },
    ...
    { loc: "/column/gym-menopause/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-sleep/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-core/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-recovery/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-motivation/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-form-check/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-flexibility/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-body-composition/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-sleep-quality/", changefreq: "monthly", priority: "0.7" },
    { loc: "/column/gym-mindfulness/", changefreq: "monthly", priority: "0.7" },
    ...regionUrls,
    ...prefectures.map((p) => ({
      loc: `/p-${p.slug}/`,
      changefreq: "weekly" as const,

...
/**
 * Generate dynamic FAQs for region page
 */
  ...
  return [
    {
      id: 1,
      gym_id: null,
      question: `${regionName}のパーソナルジムの料金相場は？`,
      answer: `${regionName}のパーソナルジムの料金は、1回あたり5,000円～15,000円が相場です。入会金は0円～50,000円程度となっています。体験レッスンは1,000円～5,000円で受けられるジムが多いため、まずは体験から始めることをおすすめします。`,
      sort_order: 1,
      is_global: false,
    },
    {
      id: 2,
      gym_id: null,
      question: `${regionName}でおすすめのパーソナルジムは？`,
      answer: `${regionName}には${totalCount}件のパーソナルジムが登録されています。評価が高いジムを当ページで表示しているので、そちらをご参照ください。また、目的別（ダイエット・女性向けなど）で探すことで、あなたにぴったりのジムが見つかりやすくなります。`,
      sort_order: 2,
      is_global: false,
    },
    {
      id: 3,
      gym_id: null,
      question: `${regionName}のパーソナルジムで女性向けプランはありますか？`,
      answer: `${regionName}の多くのパーソナルジムで女性向けプランや女性専用レッスンを提供しています。当サイトで「女性向け」のタグが付いているジムを検索することで、女性向けプランがあるジムが簡単に見つかります。`,
      sort_order: 3,
      is_global: false,
    },
    {
...
export default function RegionPage({
  ...
  return (
    <Layout>
      ...
      />
      <JsonLDListPage
        title={`${region.name}のパーソナルジム`}
        description={`${region.name}のパーソナルジム一覧`}
        path={basePath}
        items={gyms}
      />
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <section className="mt-8 p-5 bg-gray-50 rounded-lg border border-gray-200">
          <h2 className="text-xl font-bold text-gray-900 mb-3">
            {region.name}のパーソナルジムについて
          </h2>
          <p className="text-gray-700 mb-2">
            {region.name}には、ダイエット・ボディメイク・健康増進など、様々な目的に対応したパーソナルジムが{totalCount}
        ...
        {/* Prefectures Links Section */}
        {prefectures.length > 0 && (
          <section className="mt-8">
            <h2 className="text-lg font-bold text-gray-900 mb-3">
              {region.name}の都道府県から探す
            </h2>
        ...
        <section className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { href: "/column/gym-muscle/", title: "筋肉をつけるためのパーソナルジム活用法｜バルクアップと増量期のコツ" },
              { href: "/column/gym-women-50/", title: "50代女性のパーソナルジム｜更年期・骨密度・姿勢改善に効果的なトレーニング" },
        ...
        {faqs.length > 0 && (
          <section className="mt-12">
            <h2 className="text-xl font-bold text-gray-900 mb-6">
              {region.name}のパーソナルジムについてよくある質問
            </h2>

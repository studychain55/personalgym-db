...
export default function InquiryForm({ siteId, facilityTable, facilityId, facilityUid, facilityName }: Props) {
  ...
  return (
    <div>
      <div className="bg-[#f0fdf4] border border-[#bbf7d0] rounded-lg px-4 py-3 mb-5">
        <p className="text-sm font-bold text-[#166534] mb-1.5">安心してお問い合わせください</p>
        <div className="flex flex-wrap gap-x-4 gap-y-1">
          {['入力3分で完了', '返信は24時間以内', '無料で相談できます', '個人情報は安全に管理'].map((text) => (

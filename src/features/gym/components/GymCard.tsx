      ...
      <article className="bg-white rounded-xl border border-[#e9e9e9] overflow-hidden hover:shadow-lg hover:border-[#1e782d]/30 transition-all duration-200 hover:-translate-y-0.5 flex flex-col h-full">
        ...
        <div className="p-3 flex flex-col flex-1 gap-1.5">
          ...
          <div className="mt-auto pt-2">
            <div className="w-full text-center text-sm font-bold py-2.5 px-3 rounded-lg bg-[#1e782d] text-white group-hover:bg-[#155420] transition-colors shadow-sm">
              詳細を見る →
            </div>
            <p className="text-center text-[10px] text-gray-400 mt-1">無料相談・体験OK</p>
          </div>
        </div>
      </article>
    </NextLink>
